...
class MolecularAutoencoder:
    def __init__(self, latent_dim=64, max_length=120, log_dir='logs'):
    ...
    def build_model(self):
        ...
        embedding = layers.Embedding(len(self.vocab), self.max_length)(encoder_inputs)
        ...
        conv3 = layers.Conv1D(64, 3, activation="relu", padding="same")(reshape)
        conv4 = layers.Conv1D(self.max_length, 3, activation="relu", padding="same")(
            conv3
        )
